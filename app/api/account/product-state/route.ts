...
import { getProductBackendStateForAuthenticatedSession } from "@/lib/server/product";
...
export async function GET(request: NextRequest) {
  ...
  const snapshot = await getProductBackendStateForAuthenticatedSession(session);
