...
import { getCommercialScalingFoundationForAuthenticatedSession } from "@/lib/server/commercial";
...
export async function GET(request: NextRequest) {
  ...
  const snapshot = await getCommercialScalingFoundationForAuthenticatedSession(session);
