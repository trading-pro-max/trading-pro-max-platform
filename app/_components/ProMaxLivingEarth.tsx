...
function useReducedMotion(): MotionPreference {
  const [motion, setMotion] = useState<MotionPreference>("normal");

  useEffect(() => {
    const query = window.matchMedia("(prefers-reduced-motion: reduce)");
    const update = () => setMotion(query.matches ? "reduced_safe" : "normal");
    update();
...
function useUniverseMood(): UniverseMood {
...
export function ProMaxLivingEarth({
  size = "medium",
  surface = "logo",
  ...
  return (
    ...
    >
      ...
      <figcaption className={styles.caption}>
        ...
        <small>Motion: {motion === "reduced_safe" ? "reduced-safe" : "normal"}.</small>
      </figcaption>
    </figure>
  );
}
