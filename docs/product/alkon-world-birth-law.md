...
No permit may execute code, create a project, launch publicly, activate billing,
touch production, connect broker/feed, trade live, route real money, publish
socially, expose secrets, or bypass Founder authority.
