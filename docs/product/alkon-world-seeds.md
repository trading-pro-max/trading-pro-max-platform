...
security tooling, developer tooling, and future unknown ideas.

Every seed records purpose, audience, relationship to the Prime World, possible
value, possible risk, required gates, current status, allowed scope, forbidden
