...
export const PLAN_ENTITLEMENTS: PlanEntitlementContract[] = [
  {
    ...
    allowedFeatures: [
      ...
      feature("assistant", "Basic Companion", "active", "Basic platform, blocked-state, feedback, settings, and diagnostics guidance."),
    ...
    safetyRules: [
      ...
      "no deep Planet OS administration in Free / Demo workstation",
...
export const PLANET_ACCESS_LAYERS: PlanPlanetAccessLayer[] = [
  ...
  },
  {
    ...
    upgradeExplanation: "Demo / Free is active as a familiar premium paper terminal. Pro and VIP remain planned until entitlement and billing gates exist.",
  ...
  },
  {
    ...
    visualIdentity: "vip",
    activeLayer: "Elite living planet layer planned",
