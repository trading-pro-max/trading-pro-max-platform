...
const founderCommandHidden = feature(
  ...
  "hidden",
  "Owner command tools are private and are never part of Free, Pro, VIP, or Institutional user plans."
);
...
export const PLAN_ENTITLEMENTS: PlanEntitlementContract[] = [
  {
    ...
    lockedFeatures: [
      ...
      feature("assistant", "VIP Brain", "locked", "VIP Brain is planned only and not active in Demo."),
...
export const PLANET_ACCESS_LAYERS: PlanPlanetAccessLayer[] = [
  {
    ...
    hiddenFeatures: ["owner-only command tools", "private revenue research", "private internal reports"],
    ...
    mustNotShow: ["owner-only command tools", "private command data", "fake user metrics", "private revenue model"],
  },
  {
    ...
    lockedFeatures: ["Pro alerts", "workspace memory depth", "VIP Brain", "advanced reports", "private rooms"],
    plannedFeatures: ["community basic", "decision replay foundation", "academy paths"],
    hiddenFeatures: ["owner-only command tools", "private revenue controls", "private revenue research"],
    ...
    mustNotShow: ["owner-only command tools", "private revenue model", "paid checkout", "VIP active state"],
  },
  {
    citizenClass: "pro",
    label: "Pro",
    ...
    hiddenFeatures: ["owner-only command tools", "billing controls", "private revenue research"],
    ...
    mustNotShow: ["Pro active without entitlement", "checkout", "paid access", "owner-only command tools"],
  },
  {
    citizenClass: "vip",
    label: "VIP",
    ...
    hiddenFeatures: ["owner-only command tools", "private revenue research", "private revenue controls"],
    ...
    mustNotShow: ["VIP active", "guaranteed results", "private revenue model", "owner-only command tools"],
  },
  {
    ...
    hiddenFeatures: ["owner-only command tools", "private revenue research"],
    ...
    mustNotShow: ["Institutional available", "compliance certified", "team admin active", "owner-only command tools"],
  },
  {
    ...
    hiddenFeatures: ["owner-only approvals", "secrets", "private user data"],
    ...
    mustNotShow: ["secrets", "private user data", "owner command authority"],
  },
  {
    ...
    visibleCities: ["Owner Command Room", "Owner Approval Center", "All reports"],
    ...
    visualIdentity: "vip",
    activeLayer: "Private owner command layer",
    ...
    hiddenFeatures: [],
    upgradeExplanation: "Owner access is private and never part of user plans.",
