...
export const PLAN_VALUE_MAP: PlanValueMapEntry[] = [
  ...
  },
  {
    ...
    lockedCapabilities: ["advanced Assistant", "Advanced performance review", "Private rooms"],
  ...
  },
  {
    ...
    activeCapabilities: [],
    plannedCapabilities: ["Advanced Assistant", "Advanced coaching", "Deep journal analytics", "Strategy review", "Premium reports", "VIP private rooms"],
  ...
  },
  {
    ...
    supportLevel: "Private operational control.",
