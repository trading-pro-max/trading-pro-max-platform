...
export const SURFACE_BOUNDARY_CONTRACTS: SurfaceBoundaryContract[] = [
  ...
  boundary("academy", "Academy", "public_user", ["Learning paths", "Risk basics", "TPM Assistant guide"], founderHiddenSystems),
  ...
  boundary("assistant", "TPM Assistant", "public_user", ["Platform state help", "Plan guidance", "Why Blocked", "Journal/Coach prompts"], founderHiddenSystems),
