...
const areas: VisualAcceptanceScore[] = [
  ...
  area("plan_visual_identity", "Plan visual identity", 9.1, "partial", ["Plan identities now include Guest and citizen layer map readiness while paid tiers remain locked/planned truthfully."], ["Avoid making locked plans look active and keep the access map compact."]),
