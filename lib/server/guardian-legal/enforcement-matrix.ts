...
const rules: GuardianLegalEnforcementRule[] = [
  ...
  },
  {
    ...
    reason: "Private sensitive actions require explicit confirmation and audit backing before execution exists.",
    severity: "high",
    safeAlternative: "Keep private command read-only until private auth and audit gates exist.",
