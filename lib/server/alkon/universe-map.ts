  ...
  return [
    ...
    subsystem({
      ...
      linkedSystems: [
        ...
        "Execution Permit",
        "Result Tribunal",
        "Ontology & Existence System",
        "Sovereign Legitimacy",
        "Sovereign Creation & Continuity",
        "Memory Lessons",
      ],
      publicVisible: false,
      founderVisible: true,
      ...
      domains: [
        ...
        domain("Legitimacy", "ready", "Sensitive authority is checked against mission, truth, finance, timing, reputation, rollback, and Founder responsibility."),
        domain("Continuity", "ready", "Entity birth, proof, monitoring, evolution, deprecation, removal, and memory remain Founder-only and non-executing."),
        domain("Digital Universe Runtime", "ready", "Every input receives place, time, law, gravity, orbit, life, institution, reality admission, consequence, memory, and next fate."),
        domain("Result Tribunal", "review_required", "Validation and product truth decide acceptance."),
      ],
    }),
    subsystem({
      id: "digital_universe_runtime",
      name: "Digital Universe Runtime",
      symbolicRole: "Private runtime that gives every input place, time, law, gravity, orbit, proof, consequence, memory, and fate",
      status: "ready",
      readiness:
        "Ideas, risks, invoices, media messages, bugs, decisions, and results are classified into private runtime reports only.",
      linkedSystems: [
        "Space Layer",
        "Time Layer",
        "Law Layer",
      ...
      riskLevel: "high",
      nextAction:
        "Keep runtime read-only and private; use it to recommend next fate, never to execute payment, deletion, shell, Codex, launch, billing, broker/feed, live, or publishing actions.",
      domains: [
        domain("Runtime flow", "ready", "Birth to Next Fate is deterministic and proof-backed."),
        domain("Black-hole guard", "ready", "Forbidden activations, secrets, payment execution, fake claims, and public Alkon exposure are isolated."),
        domain("Reality admission", "ready", "No input enters public reality without validation, support, rollback, and boundary checks."),
      ],
    }),
    subsystem({
      id: "memory_universe",
    ...
    subsystem({
      ...
      domains: [
        ...
        domain("Ontology", "ready", "Every major entity has private meaning, owner, validation, memory, and stay/removal law."),
        domain("Legitimacy", "ready", "Authority use must deserve to exist before it can be permitted."),
        domain("Continuity", "ready", "New and existing entities live under birth, identity, proof, lifecycle, removal, and memory law."),
