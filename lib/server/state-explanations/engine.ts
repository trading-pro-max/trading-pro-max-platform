...
const explanations: ProductStateExplanation[] = [
  ...
  explanation("founder_command_private", "Private command tools are separate", "blocked", "Private command tools are not a normal product route or plan feature.", "Keep private command tools hidden from public navigation until private auth exists.", "founder", "owner_private", "Private device auth, step-up confirmation, and audit gates exist.", "founder", "hidden"),
];
