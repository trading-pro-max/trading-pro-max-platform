...
const explanations: ProductStateExplanation[] = [
  ...
  explanation("founder_command_private", "Founder Command private", "blocked", "Founder Command is owner-only and not a normal product route or plan feature.", "Keep it hidden from public navigation until private owner auth exists.", "founder", "owner_private", "Owner-only device auth, step-up confirmation, and audit gates exist.", "founder", "hidden"),
];
