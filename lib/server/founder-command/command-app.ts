...
export function getFounderCommandAppSnapshot(
  ...
  return {
    ...
    brandClearance: {
      ...
      finalBrandApproved: brandClearance.finalBrandApproved,
      launchBlockedByBrandGate: brandClearance.launchBlockedByBrandGate,
      ...
      oneNextAction: brandClearance.oneNextAction.action,
