...
const items: ProductTruthItem[] = [
  ...
  },
  {
    ...
    state: "guarded",
    publicCopy: "Private command tools are not a user feature.",
    internalCopy: "Private command remains read-only by default and hidden from Free, Pro, VIP, Institutional, and public navigation.",
    safeNextStep: "Keep command room surfaces component/API foundation only until private auth, device trust, and audit gates exist.",
    mustNotClaim: ["admin dashboard available", "private command public", "plan access to private command"],
  },
  {
    ...
    internalCopy: "Guest, Free, Pro, VIP, Institutional, Staff, and private command classes are access models, not fake paid activation.",
    safeNextStep: "Keep Free active, Pro/VIP planned, Institutional future, and private command separate.",
    mustNotClaim: ["VIP active", "Pro paid active", "Institutional available", "private command as user plan"],
  },
  {
