# Source-to-Reality Ownership Map

Status: active_with_notes

| Source-to-Reality Node | Meaning | Codebase / filesystem location |
| --- | --- | --- |
...
| Memory | Return layer | reports, wake reports, Jar memory, execution history |
| Zero Truth | Cycle closure | Wake Report and next command truth |

Public/private rule:

Public Pro Max receives only public-safe language. Private Alkon -0 remains Founder-only.
