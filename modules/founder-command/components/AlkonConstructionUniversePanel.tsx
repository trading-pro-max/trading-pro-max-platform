...
export default function AlkonConstructionUniversePanel({
  snapshot,
}: {
  snapshot: AlkonUniverseSnapshot;
}) {
  const command = snapshot.constructionUniverse;

  return (
    <article className="tpm-founder-subpanel alkon-construction-universe">
